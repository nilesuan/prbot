...
docker pull ghcr.io/nilesuan/prbot:0.5.0
docker tag ghcr.io/nilesuan/prbot:0.5.0 registry.example.com/prbot:0.5.0
docker push registry.example.com/prbot:0.5.0
```
...
```yaml
prbot-review:
  image: registry.example.com/prbot:0.5.0
  # ...
```
