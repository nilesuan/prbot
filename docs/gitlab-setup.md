...
docker pull ghcr.io/nilesuan/prbot:0.4.1
docker tag ghcr.io/nilesuan/prbot:0.4.1 registry.example.com/prbot:0.4.1
docker push registry.example.com/prbot:0.4.1
```
...
```yaml
prbot-review:
  image: registry.example.com/prbot:0.4.1
  # ...
```
