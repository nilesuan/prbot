...
prbot-review:
  stage: test
  image: ghcr.io/nilesuan/prbot:0.2.0
  id_tokens:
    GITLAB_OIDC_TOKEN:
...
docker pull ghcr.io/nilesuan/prbot:0.2.0
docker tag ghcr.io/nilesuan/prbot:0.2.0 registry.example.com/prbot:0.2.0
docker push registry.example.com/prbot:0.2.0
```
...
```yaml
prbot-review:
  image: registry.example.com/prbot:0.2.0
  # ...
```
